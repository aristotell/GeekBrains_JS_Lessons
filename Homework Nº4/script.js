...
function homework_1() {
    document.getElementById("content1").innerHTML = ('<div class="form"><input type="text" id="in_number"></br><label for="in_number">Введите номер от 0 до 999</label></br><input type="button" name="ok" id="in_number" value="Подтвердить" onClick="conf()"></div></br>');
}
let i = 0;
let arr_numberObj = [];
